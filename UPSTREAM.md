...
| Tag | `v1.2.18` |
| Commit | `d4cbace35e570b4ce0b2413ab018cafd779f13a9` |
| Downstream branch | `patched/v1.2.18` |
| Downstream release tag | `v1.2.18-macos-arm64.1` |
| Patchset version | `1` |
...
and cherry-pick the six patch commits in the order listed in `PATCHES.md`.
